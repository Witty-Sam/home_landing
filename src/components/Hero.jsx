...
const Hero = () => {
  ...
  return (
    <div className="flex flex-col items-center text-center w-[auto] min-h-auto bg-cover bg-center mt-[100px] mb-[-6px]"
    style={{ backgroundImage: "url('./images/Background.svg')", overflow: "hidden", maxWidth: "auto" }}>
