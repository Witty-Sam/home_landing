...
const Body2 = () => {
  ...
  <tr className="align-top ">
            ...
            <text className="text-[15px] mt-[2px] text-[#6A6A6A] ">Banks face challenges with high default rates,<br/> identity fraud, and lengthy loan approval processes.<br/> Vida streamlines the lending process, enabling<br/> banks to make faster, safer, and more profitable <br/>credit decisions with AI-powered insights.</text>
             

             <h1 className="text-[22px] mt-[50px]">Cooperative Societies</h1>

             <text className="text-[15px] mt-[2px] text-[#6A6A6A]">Cooperative societies face high default rates due to<br/> the lack of reliable credit history for new members.<br/> With Vida, cooperative societies can now assess the<br/> creditworthiness of potential members before<br/> granting them access to loans.</text>
